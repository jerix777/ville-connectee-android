-- Insertion de données de test pour la fonctionnalité Association avec dates correctes
...
('Association des Jeunes de Yopougon', 'Association dédiée à l''encadrement et à l''épanouissement des jeunes du quartier de Yopougon', 'contact@ajy.ci | 0707123456', 'active', '2024-01-15'::date, 0),
('Coopérative des Femmes Entrepreneures', 'Coopérative pour soutenir l''entrepreneuriat féminin et le développement économique local', 'info@cfentrepreneures.ci | 0708987654', 'active', '2024-02-20'::date, 0),
