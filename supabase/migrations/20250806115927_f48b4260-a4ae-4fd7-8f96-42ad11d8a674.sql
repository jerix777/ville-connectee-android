-- Insertion de données de test pour la fonctionnalité Association avec des UUIDs corrects
...
('Association des Jeunes de Yopougon', 'Association dédiée à l''encadrement et à l''épanouissement des jeunes du quartier de Yopougon', 'contact@ajy.ci | 0707123456', 'active', '2024-01-15', 0),
('Coopérative des Femmes Entrepreneures', 'Coopérative pour soutenir l''entrepreneuriat féminin et le développement économique local', 'info@cfentrepreneures.ci | 0708987654', 'active', '2024-02-20', 0),
('Club Sportif Espoir', 'Club de football et d''activités sportives pour tous les âges', 'espoir.sport@gmail.com | 0701234567', 'active', '2024-03-10', 0);
...
-- Mettre à jour le nombre de membres dans les associations (à la fin)
