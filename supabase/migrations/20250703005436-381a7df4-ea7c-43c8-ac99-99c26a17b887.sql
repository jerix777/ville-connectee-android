-- Vérifier et ajouter les politiques RLS manquantes pour les tables sans politiques INSERT/UPDATE/DELETE

-- Pour les immobiliers (pas de RLS activé)
...
-- Pour la nécrologie (pas de RLS activé)
...
-- Pour les services et commerces (pas de RLS activé)
...
-- Pour les souvenirs (pas de RLS activé)
...
-- Pour les suggestions (pas de RLS activé)
...
-- Pour la tribune (pas de RLS activé)
...
-- Pour les villages (pas de RLS activé)
...
-- Pour les quartiers (pas de RLS activé)
...
-- Pour les communes (pas de RLS activé)
...
-- Pour les préférences de commune (pas de RLS activé)
