  ...
  public: {
    Tables: {
      ...
      annuaires: {
        ...
        Relationships: [
          {
            foreignKeyName: "annuaires_quartier_id_fkey"
            columns: ["quartier_id"]
            isOneToOne: false
            referencedRelation: "quartiers"
            referencedColumns: ["id"]
      ...
      directory_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "directory_entries_village_id_fkey"
            columns: ["village_id"]
            isOneToOne: false
      ...
      professionals: {
        ...
        Relationships: [
          {
            foreignKeyName: "professionals_metier_id_fkey"
            columns: ["metier_id"]
            isOneToOne: false
      ...
      radios: {
        ...
        Relationships: [
          {
            foreignKeyName: "radios_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "radio_categories"
            referencedColumns: ["id"]
          },
        ]
      }
