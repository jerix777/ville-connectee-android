        ...
        <div>
          ...
          <Select value={typeFilter} onValueChange={onTypeChange}>
            ...
            <SelectContent>
              ...
              <SelectItem value="station-service">Stations-service</SelectItem>
              <SelectItem value="depot-gaz">Dépôts de gaz</SelectItem>
              <SelectItem value="station-mixte">Stations mixtes</SelectItem>
            </SelectContent>
          </Select>
        </div>
