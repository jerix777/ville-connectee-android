...
export function AddAnnouncementForm({ associationId, onSuccess, onCancel }: AddAnnouncementFormProps) {
  const [formData, setFormData] = useState({
    titre: '',
    contenu: '',
    priorite: 'normale' as 'haute' | 'moyenne' | 'normale',
    visible_jusqu: ''
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await associationService.createAnnonce({
        ...
        auteur_id: 'current-user-id', // TODO: Get from auth context
