...
export function EtablissementCard({ etablissement, onCall, onDirections }: EtablissementCardProps) {
  const handleCall = () => {
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              <Badge 
                variant="outline" 
                className={typeColors[etablissement.type] || 'bg-gray-100 text-gray-800 border-gray-200'}
              >
