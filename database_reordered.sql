-- Reordered schema for correct execution.
...
CREATE TYPE public.user_role_type AS ENUM ('administre', 'autorite', 'developpeur');
...
CREATE TABLE public.user_roles (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  user_id uuid NOT NULL,
  role user_role_type NOT NULL DEFAULT 'administre'::user_role_type,
  sub_role text,
  created_at timestamp with time zone DEFAULT now(),
